...
(function() {
  var BBox, Bend, Crossover, Join, Merge, Piece, Split, Straight, Track, TrackPainter, Transform, root, transformsMeet, _ref, _ref1, _ref2, _ref3, _ref4, _ref5,
  ...
  Track = (function() {
    ...
    Track.prototype._closeLoops = function() {
      ...
      return (function() {
        ...
        return _results;
      }).apply(this).forEach(function(idx1) {
    ...
    Section = (function() {
      ...
      Section.prototype.compoundTransform = function(n, connection) {
        ...
        (function() {
          ...
          return _results;
        }).apply(this).forEach(function(pieceIndex) {
  ...
  TrackPainter = (function() {
    ...
    TrackPainter.prototype.draw = function() {
      var _this = this;
      this._clear();
      this.track._sections.forEach(function(section) {
        var start;
        start = section.transform();
        return section._pieces.forEach(function(piece) {
          if (_this.showBBox) {
      ...
      if (this.showCodes) {
        this.track.connections().forEach(function(code) {
  ...
  Straight = (function(_super) {
    ...
    function Straight() {
      _ref = Straight.__super__.constructor.apply(this, arguments);
      return _ref;
    }
  ...
  Bend = (function(_super) {
    ...
    function Bend() {
      _ref1 = Bend.__super__.constructor.apply(this, arguments);
      return _ref1;
    }
  ...
  Split = (function(_super) {
    ...
    function Split() {
      _ref2 = Split.__super__.constructor.apply(this, arguments);
      return _ref2;
    }
  ...
  Join = (function(_super) {
    ...
    function Join() {
      _ref3 = Join.__super__.constructor.apply(this, arguments);
      return _ref3;
    }
  ...
  Merge = (function(_super) {
    ...
    function Merge() {
      _ref4 = Merge.__super__.constructor.apply(this, arguments);
      return _ref4;
    }
  ...
  Crossover = (function(_super) {
    ...
    function Crossover() {
      ...
      _ref5 = Crossover.__super__.constructor.apply(this, arguments);
      return _ref5;
    }
